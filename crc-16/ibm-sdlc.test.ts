...
Deno.test('table', () => {
	assertEquals(CRC_16_IBM_SDLC.table(), table);
});

Deno.test('123456789', () => {
	let c = CRC_16_IBM_SDLC.init();
	c = CRC_16_IBM_SDLC.update(c, new TextEncoder().encode('123456789'));
	c = CRC_16_IBM_SDLC.finalize(c);
	assertEquals(c, 0x906e);
});
