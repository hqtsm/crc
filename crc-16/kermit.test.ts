...
Deno.test('table', () => {
	assertEquals(CRC_16_KERMIT.table(), table);
});

Deno.test('123456789', () => {
	let c = CRC_16_KERMIT.init();
	c = CRC_16_KERMIT.update(c, new TextEncoder().encode('123456789'));
	c = CRC_16_KERMIT.finalize(c);
	assertEquals(c, 0x2189);
});
